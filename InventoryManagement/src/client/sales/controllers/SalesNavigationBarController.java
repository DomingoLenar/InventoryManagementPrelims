...
//            }
//        });
        salesNavigationBarView.getStockMonitorButton().addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                inventoryManagementController.getSalesStockMonitorController().initComponents();
